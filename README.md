...
Hi there, I'm **John Shull**, a **Research Scientist** :rocket: with [Old Dominion University](https://www.odu.edu/) under the [Virginia Institute for Spaceflight & Autonomy (VISA)](https://visaatodu.org/). We are located in the Virginia Modeling Analysis Simulation Center ([VMASC](https://vmasc.org/)🌍) and sometimes I **Adjunct** with the [Game Studies & Design Program](https://www.odu.edu/academics/programs/undergraduate/game-studies-design) :space_invader: at ODU 🚀!  Currently, I'm working on the [**Angry Birds**](https://seagrant.noaa.gov/wp-content/uploads/2026/03/Sea-Grant-FY25-Aquaculture-Investments_508.pdf) project (also actually titled 'Innovative avian deterrence strategies for sustainable aquaculture'), funded in the 2025 by NOAA and Sea Grant. This project leverages YOLO models and other AI/ML workflows to help support the local aquaculture industry. This effort is in partnership/collaboration with the Commercial Shellfish Aquaculture Lab & Team ([CSALT](https://www.vims.edu/research/units/labgroups/csalt/)) and we are leveraging existing research by [Dr. John Swaddle](https://www.wm.edu/offices/iic/about/people/faculty_staff/dir_swaddle-john.php) with the use of Sonic Nets and Semi-Autonomous Vessels to research avian deterrence strategies :eagle:. The plan is to utilize as many on the edge devices as we can, leverage advances [mesh networks like the haven-manet-ip-mesh-radio](https://github.com/buildwithparallel/haven-manet-ip-mesh-radio), and a local "smart" system powered by the [Nvidia DGX Spark](https://www.nvidia.com/en-us/products/workstations/dgx-spark/). We are also exploring the use of real-time game engines like [Unity](https://unity.com/) to generate high quality synthetic training data to help fill in the gaps! You can read our [narrative to the proposal here](https://github.com/JShull/JShull/blob/main/NOAA_SubmissionNarrative.pdf). 
<br />
When I'm not tinkering about, I'm probably learning life lessons from my amazing significant other :heart: or perhaps gaming :video_game: with my core 'west-coast' group trying to break EA game-engine physics 😉 or maybe just jamming to some [Above & Beyond](https://music.apple.com/us/artist/above-beyond/20318188), and in some circumstances hanging out with the other Fuzz's... :eyes:
